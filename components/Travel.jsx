...
const EDIT_ROLES = ['Organisation Staff', 'Coaching Staff', 'GM', 'Headcoach', 'Staff/Orga'];
...
function ParticipantsModal({ tripId, currentIds, lang, onSave, onClose }) {
  ...
  const ROLE_ORDER = ['Player', 'Headcoach', 'Athletic', 'Therapist', 'Coaching Staff', 'Organisation Staff', 'Staff/Orga', 'GM'];
