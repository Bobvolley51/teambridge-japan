...
const CATEGORIES = ['Ball-Practice', 'Weightlifting', 'Game', 'Meeting', 'Travel', 'Medical', 'Birthday', 'Special-Event', 'Other'];

const CAT_LABEL = {
  en: { 'Ball-Practice': 'Ball Practice', Weightlifting: 'Weightlifting / Athletic', Game: 'Game', Meeting: 'Meeting', Travel: 'Travel', Medical: 'Medical/Physio', Birthday: '🎂 Birthday', 'Special-Event': '⭐ Special Event', Other: 'Other' },
  ja: { 'Ball-Practice': 'ボール練習', Weightlifting: 'ウェイト・アスレチック', Game: '試合', Meeting: 'ミーティング', Travel: '旅行', Medical: 'メディカル/フィジオ', Birthday: '🎂 誕生日', 'Special-Event': '⭐ 特別イベント', Other: 'その他' },
};

const DEFAULT_DURATION = { 'Ball-Practice': 120, Weightlifting: 75, Game: 240, Meeting: 30, Travel: 300, Medical: 60, Birthday: 1440, 'Special-Event': 120, Other: 300 };
...
const CAT = {
  ...
  'Special-Event':{ bg: '#ffedd5', text: '#7c2d12', solid: '#ea580c' },
